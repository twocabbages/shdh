...
function fictive_google_fonts() {
	...
	if ( 'off' !== _x( 'on', 'Open Sans font: on or off', 'fictive' ) ) {
		...
		wp_register_style( 'fictive-open-sans', "$protocol://fonts.useso.com/css?family=Open+Sans:300italic,400italic,700italic,400,300,700" );
	...
	if ( 'off' !== _x( 'on', 'Bitter font: on or off', 'fictive' ) ) {
		...
		wp_register_style( 'fictive-bitter', "$protocol://fonts.useso.com/css?family=Bitter:400,700,400italic&subset=latin,latin-ext" );
